...
public class BranchFAuto extends AutoModeBase {

	public BranchFAuto(AutoFactory factory) {
		super(factory, "branch f auto");

		AutoTrajectory fToStation = trajectory("fToStation");

		Pose2d startPose =
				FieldLayout.handleAllianceFlip(new Pose2d(7.17, 1.87, Rotation2d.kZero), RobotConstants.isRedAlliance);
